...
import { unwrapDataWrapper } from "@ckb-lumos/ckb-indexer/lib/ckbIndexerFilter";
import { CKBCellCollector } from "@ckb-lumos/ckb-indexer/lib/collector";
import type * as IndexerType from "@ckb-lumos/ckb-indexer/lib/indexerType";
import { RPC as CKBIndexerRpc } from "@ckb-lumos/ckb-indexer/lib/rpc";
import { requestBatchTransactionWithStatus } from "@ckb-lumos/ckb-indexer/lib/services";
import {
...
export class CkbIndexer implements CellProvider, TerminableCellFetcher {
  ...
  private getCkbRpc(): CKBRPC {
    return new CKBRPC(this.uri, { fetch: customizedFetch });
  }
