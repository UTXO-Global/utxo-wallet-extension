...
const FinalleSend = () => {
  ...
  const onClick = async () => {
    await browserTabsCreate({
      active: true,
      url: `${currentNetwork.explorerUrl}/${isCkbNetwork(currentNetwork.network) ? "transaction" : "tx"
        }/${txId}`,
    });
  };
